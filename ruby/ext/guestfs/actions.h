...
extern VALUE guestfs_int_ruby_inspect_get_windows_group_policy (VALUE gv, VALUE rootv);
...
extern VALUE guestfs_int_ruby_ntfs_chmod (int argc, VALUE *argv, VALUE gv);
...
extern VALUE guestfs_int_ruby_setfiles (int argc, VALUE *argv, VALUE gv);
