...
guestfs_int_ruby_dd (VALUE gv, VALUE srcv, VALUE destv)
{
  ...
  rb_warn ("Guestfs#dd is deprecated; use #copy_device_to_device instead");
...
guestfs_int_ruby_get_qemu (VALUE gv)
{
  ...
  rb_warn ("Guestfs#get_qemu is deprecated; use #get_hv instead");
...
guestfs_int_ruby_inspect_is_netinst (VALUE gv, VALUE rootv)
{
  ...
  rb_warn ("Guestfs#inspect_is_netinst is deprecated");
...
guestfs_int_ruby_inspect_list_applications2 (VALUE gv, VALUE rootv)
{
  ...
  for (i = 0; i < r->len; ++i) {
    ...
    rb_hash_aset (hv, rb_str_new2 ("app2_class"), rb_str_new2 (r->val[i].app2_class));
...
guestfs_int_ruby_llz (VALUE gv, VALUE directoryv)
{
  ...
  rb_warn ("Guestfs#llz is deprecated; use #lgetxattrs instead");
...
guestfs_int_ruby_lstat (VALUE gv, VALUE pathv)
{
  ...
  rb_warn ("Guestfs#lstat is deprecated; use #lstatns instead");
...
guestfs_int_ruby_lstatlist (VALUE gv, VALUE pathv, VALUE namesv)
{
  ...
  rb_warn ("Guestfs#lstatlist is deprecated; use #lstatnslist instead");
 ...
 *
 * [Deprecated] In new code, use rdoc-ref:setfiles instead.
 *
...
guestfs_int_ruby_selinux_relabel (int argc, VALUE *argv, VALUE gv)
{
  ...
  rb_warn ("Guestfs#selinux_relabel is deprecated; use #setfiles instead");
...
guestfs_int_ruby_vgscan (VALUE gv)
{
  ...
  rb_warn ("Guestfs#vgscan is deprecated; use #lvm_scan instead");
...
guestfs_int_ruby_zegrepi (VALUE gv, VALUE regexv, VALUE pathv)
{
  ...
  rb_warn ("Guestfs#zegrepi is deprecated; use #grep instead");
...
guestfs_int_ruby_zfgrep (VALUE gv, VALUE patternv, VALUE pathv)
{
  ...
  rb_warn ("Guestfs#zfgrep is deprecated; use #grep instead");
...
guestfs_int_ruby_zfile (VALUE gv, VALUE methv, VALUE pathv)
{
  ...
  rb_warn ("Guestfs#zfile is deprecated; use #file instead");
