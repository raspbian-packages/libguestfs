...
#define rb_alloc_func_t void*
  ...
  rb_define_method (c_guestfs, "inspect_get_windows_group_policy",
                    guestfs_int_ruby_inspect_get_windows_group_policy, 1);
  ...
  rb_define_method (c_guestfs, "luks_uuid",
                    guestfs_int_ruby_luks_uuid, 1);
  ...
  rb_define_method (c_guestfs, "ntfs_chmod",
                    guestfs_int_ruby_ntfs_chmod, -1);
  ...
  rb_define_method (c_guestfs, "setfiles",
                    guestfs_int_ruby_setfiles, -1);
