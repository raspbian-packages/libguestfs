...
guestfs_int_ruby_blockdev_setbsz (VALUE gv, VALUE devicev, VALUE blocksizev)
{
  ...
  rb_warn ("Guestfs#blockdev_setbsz is deprecated");
...
guestfs_int_ruby_egrepi (VALUE gv, VALUE regexv, VALUE pathv)
{
  ...
  rb_warn ("Guestfs#egrepi is deprecated; use #grep instead");
...
guestfs_int_ruby_fallocate (VALUE gv, VALUE pathv, VALUE lenv)
{
  ...
  rb_warn ("Guestfs#fallocate is deprecated; use #fallocate64 instead");
...
guestfs_int_ruby_fgrep (VALUE gv, VALUE patternv, VALUE pathv)
{
  ...
  rb_warn ("Guestfs#fgrep is deprecated; use #grep instead");
...
guestfs_int_ruby_get_direct (VALUE gv)
{
  ...
  rb_warn ("Guestfs#get_direct is deprecated; use #internal_get_console_socket instead");
...
/*
 * call-seq:
 *   g.inspect_get_windows_group_policy(root) -> [True|False]
 *
 ...
 *
 *
 * [Since] Added in version 1.57.6.
 *
 * [C API] For the C API documentation for this function, see
 *         {guestfs_inspect_get_windows_group_policy}[http://libguestfs.org/guestfs.3.html#guestfs_inspect_get_windows_group_policy].
 */
VALUE
guestfs_int_ruby_inspect_get_windows_group_policy (VALUE gv, VALUE rootv)
{
  guestfs_h *g;
  TypedData_Get_Struct (gv, guestfs_h, &guestfs_h_data_type, g);
  if (!g)
    rb_raise (rb_eArgError, "%s: used handle after closing it", "inspect_get_windows_group_policy");
...
guestfs_int_ruby_mke2journal_L (VALUE gv, VALUE blocksizev, VALUE labelv, VALUE devicev)
{
  ...
  rb_warn ("Guestfs#mke2journal_L is deprecated; use #mke2fs instead");
...
guestfs_int_ruby_mkswap_L (VALUE gv, VALUE labelv, VALUE devicev)
{
  ...
  rb_warn ("Guestfs#mkswap_L is deprecated; use #mkswap instead");
...
guestfs_int_ruby_wait_ready (VALUE gv)
{
  ...
  rb_warn ("Guestfs#wait_ready is deprecated");
...
guestfs_int_ruby_zegrep (VALUE gv, VALUE regexv, VALUE pathv)
{
  ...
  rb_warn ("Guestfs#zegrep is deprecated; use #grep instead");
