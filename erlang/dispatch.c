...
dispatch (ei_x_buff *retbuff, const char *buff, int *index)
{
  ...
  else if (atom_equals (fun, "inspect_get_windows_group_policy"))
    return run_inspect_get_windows_group_policy (retbuff, buff, index);
  ...
  else if (atom_equals (fun, "ntfs_chmod"))
    return run_ntfs_chmod (retbuff, buff, index);
  ...
  else if (atom_equals (fun, "setfiles"))
    return run_setfiles (retbuff, buff, index);
