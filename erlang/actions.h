...
int run_btrfs_scrub_full (ei_x_buff *retbuff, const char *buff, int *index);
...
int run_command_out (ei_x_buff *retbuff, const char *buff, int *index);
...
int run_inspect_get_windows_group_policy (ei_x_buff *retbuff, const char *buff, int *index);
...
int run_ntfs_chmod (ei_x_buff *retbuff, const char *buff, int *index);
...
int run_setfiles (ei_x_buff *retbuff, const char *buff, int *index);
...
int run_sh_out (ei_x_buff *retbuff, const char *buff, int *index);
