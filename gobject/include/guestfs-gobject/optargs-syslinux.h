...
#ifndef GUESTFS_GOBJECT_OPTARGS_SYSLINUX_H__
#define GUESTFS_GOBJECT_OPTARGS_SYSLINUX_H__
 ...
 */
typedef struct _GuestfsSyslinux GuestfsSyslinux;
struct _GuestfsSyslinux {
  GObject parent;
  GuestfsSyslinuxPrivate *priv;
};

/**
 * GuestfsSyslinuxClass:
 * @parent_class: The superclass of GuestfsSyslinuxClass
 *
 * A class metadata object for GuestfsSyslinux.
 */
typedef struct _GuestfsSyslinuxClass GuestfsSyslinuxClass;
struct _GuestfsSyslinuxClass {
...
#endif /* GUESTFS_GOBJECT_OPTARGS_SYSLINUX_H__ */
