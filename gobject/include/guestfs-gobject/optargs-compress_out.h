...
#ifndef GUESTFS_GOBJECT_OPTARGS_COMPRESS_OUT_H__
#define GUESTFS_GOBJECT_OPTARGS_COMPRESS_OUT_H__
 ...
 * @parent_class: The superclass of GuestfsCompressOutClass
 *
...
#endif /* GUESTFS_GOBJECT_OPTARGS_COMPRESS_OUT_H__ */
