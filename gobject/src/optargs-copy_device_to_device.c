...
G_DEFINE_TYPE_WITH_CODE (GuestfsCopyDeviceToDevice, guestfs_copy_device_to_device, G_TYPE_OBJECT,
                         G_ADD_PRIVATE (GuestfsCopyDeviceToDevice));
...
enum {
  ...
  PROP_GUESTFS_COPY_DEVICE_TO_DEVICE_APPEND
};
...
guestfs_copy_device_to_device_set_property(GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
  ...
  switch (property_id) {
    ...
    case PROP_GUESTFS_COPY_DEVICE_TO_DEVICE_APPEND:
...
guestfs_copy_device_to_device_class_init (GuestfsCopyDeviceToDeviceClass *klass)
{
  ...
  /**
   * GuestfsCopyDeviceToDevice:sparse:
   *
   * A boolean.
   */
  g_object_class_install_property (
  ...
  /**
   * GuestfsCopyDeviceToDevice:append:
   *
   * A boolean.
   */
  g_object_class_install_property (
...
{
  o->priv = guestfs_copy_device_to_device_get_instance_private (o);
