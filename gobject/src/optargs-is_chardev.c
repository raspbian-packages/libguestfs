...
G_DEFINE_TYPE_WITH_CODE (GuestfsIsChardev, guestfs_is_chardev, G_TYPE_OBJECT,
                         G_ADD_PRIVATE (GuestfsIsChardev));
...
{
  o->priv = guestfs_is_chardev_get_instance_private (o);
