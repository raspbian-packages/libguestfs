...
#define GUESTFS_ADD_DRIVE_SCRATCH_BLOCKSIZE 2
...
# define GUESTFS_ADD_DRIVE_SCRATCH_LABEL_BITMASK (UINT64_C(1)<<1)
  const char *label;
# define GUESTFS_ADD_DRIVE_SCRATCH_BLOCKSIZE_BITMASK (UINT64_C(1)<<2)
  int blocksize;
};
...
#define GUESTFS_HAVE_CRYPTSETUP_CLOSE 1
extern GUESTFS_DLL_PUBLIC int guestfs_cryptsetup_close (guestfs_h *g, const char *device);
...
struct guestfs_cryptsetup_open_argv {
  uint64_t bitmask;
...
#define GUESTFS_HAVE_INSPECT_GET_WINDOWS_GROUP_POLICY 1
extern GUESTFS_DLL_PUBLIC int guestfs_inspect_get_windows_group_policy (guestfs_h *g, const char *root);
...
extern GUESTFS_DLL_PUBLIC int guestfs_luks_close (guestfs_h *g, const char *device)
  GUESTFS_DEPRECATED_REPLACED_BY ("cryptsetup_close");
#endif /* !GUESTFS_NO_DEPRECATED */
...
extern GUESTFS_DLL_PUBLIC int guestfs_luks_open (guestfs_h *g, const char *device, const char *key, const char *mapname)
  GUESTFS_DEPRECATED_REPLACED_BY ("cryptsetup_open");
#endif /* !GUESTFS_NO_DEPRECATED */
...
#define GUESTFS_HAVE_LUKS_UUID 1
extern GUESTFS_DLL_PUBLIC char *guestfs_luks_uuid (guestfs_h *g, const char *device);
...
#define GUESTFS_HAVE_NTFS_CHMOD 1
#define GUESTFS_NTFS_CHMOD_RECURSIVE 0
extern GUESTFS_DLL_PUBLIC int guestfs_ntfs_chmod (guestfs_h *g, const char *device, int mode, const char *path, ...);
extern GUESTFS_DLL_PUBLIC int guestfs_ntfs_chmod_va (guestfs_h *g, const char *device, int mode, const char *path, va_list args);

struct guestfs_ntfs_chmod_argv {
  uint64_t bitmask;
# define GUESTFS_NTFS_CHMOD_RECURSIVE_BITMASK (UINT64_C(1)<<0)
  int recursive;
};

extern GUESTFS_DLL_PUBLIC int guestfs_ntfs_chmod_argv (guestfs_h *g, const char *device, int mode, const char *path, const struct guestfs_ntfs_chmod_argv *optargs);
...
extern GUESTFS_DLL_PUBLIC int guestfs_selinux_relabel (guestfs_h *g, const char *specfile, const char *path, ...)
  GUESTFS_DEPRECATED_REPLACED_BY ("setfiles");
#endif /* !GUESTFS_NO_DEPRECATED */
...
#define GUESTFS_HAVE_SETFILES 1
#define GUESTFS_SETFILES_FORCE 0
extern GUESTFS_DLL_PUBLIC int guestfs_setfiles (guestfs_h *g, const char *specfile, char *const *paths, ...);
extern GUESTFS_DLL_PUBLIC int guestfs_setfiles_va (guestfs_h *g, const char *specfile, char *const *paths, va_list args);

struct guestfs_setfiles_argv {
  uint64_t bitmask;
# define GUESTFS_SETFILES_FORCE_BITMASK (UINT64_C(1)<<0)
  int force;
};

extern GUESTFS_DLL_PUBLIC int guestfs_setfiles_argv (guestfs_h *g, const char *specfile, char *const *paths, const struct guestfs_setfiles_argv *optargs);
...
#define LIBGUESTFS_HAVE_CRYPTSETUP_CLOSE 1
#define LIBGUESTFS_HAVE_CRYPTSETUP_OPEN 1
...
#define LIBGUESTFS_HAVE_INSPECT_GET_WINDOWS_GROUP_POLICY 1
...
#define LIBGUESTFS_HAVE_LUKS_UUID 1
...
#define LIBGUESTFS_HAVE_NTFS_CHMOD 1
...
#define LIBGUESTFS_HAVE_SETFILES 1
