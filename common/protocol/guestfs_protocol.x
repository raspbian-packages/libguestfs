...
typedef struct guestfs_int_yara_detection guestfs_int_yara_detection_list<>;
...
struct guestfs_inspect_get_windows_group_policy_args {
  string root<>;
};

struct guestfs_inspect_get_windows_group_policy_ret {
  bool hasgrouppolicy;
};
...
struct guestfs_ntfs_chmod_args {
  string device<>;
  int mode;
  string path<>;
  bool recursive;
...
enum guestfs_procedure {
  ...
  GUESTFS_PROC_INSPECT_GET_WINDOWS_GROUP_POLICY = 521,
