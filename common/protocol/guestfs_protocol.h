...
typedef struct guestfs_inspect_get_windows_group_policy_args guestfs_inspect_get_windows_group_policy_args;

struct guestfs_inspect_get_windows_group_policy_ret {
	bool_t hasgrouppolicy;
};
typedef struct guestfs_inspect_get_windows_group_policy_ret guestfs_inspect_get_windows_group_policy_ret;
...
typedef struct guestfs_ntfs_chmod_args guestfs_ntfs_chmod_args;
...
typedef struct guestfs_setfiles_args guestfs_setfiles_args;
...
#define GUESTFS_MAX_PROC_NR 521
...
extern  bool_t xdr_guestfs_inspect_get_windows_group_policy_args (XDR *, guestfs_inspect_get_windows_group_policy_args*);
extern  bool_t xdr_guestfs_inspect_get_windows_group_policy_ret (XDR *, guestfs_inspect_get_windows_group_policy_ret*);
...
extern  bool_t xdr_guestfs_ntfs_chmod_args (XDR *, guestfs_ntfs_chmod_args*);
...
extern  bool_t xdr_guestfs_setfiles_args (XDR *, guestfs_setfiles_args*);
...
extern bool_t xdr_guestfs_inspect_get_windows_group_policy_args ();
extern bool_t xdr_guestfs_inspect_get_windows_group_policy_ret ();
...
extern bool_t xdr_guestfs_ntfs_chmod_args ();
...
extern bool_t xdr_guestfs_setfiles_args ();
