...
external inspect_get_windows_group_policy : t -> string -> bool = "guestfs_int_ocaml_inspect_get_windows_group_policy"
...
external ntfs_chmod : t -> ?recursive:bool -> string -> int -> string -> unit = "guestfs_int_ocaml_ntfs_chmod"
...
external setfiles : t -> ?force:bool -> string -> string array -> unit = "guestfs_int_ocaml_setfiles"
...
class guestfs ?environment ?close_on_exit () =
  ...
  object (self)
    ...
    method inspect_get_windows_group_policy = inspect_get_windows_group_policy g
    ...
    method ntfs_chmod = ntfs_chmod g
