...
external cryptsetup_open : t -> ?readonly:bool -> ?crypttype:string -> string -> string -> string -> unit = "guestfs_int_ocaml_cryptsetup_open_byte" "guestfs_int_ocaml_cryptsetup_open"
