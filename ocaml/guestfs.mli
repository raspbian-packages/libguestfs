...
module Errno : sig
  ...
  (** Integer value of errno [ENOSPC].  See {!Guestfs.last_errno}. *)
end
...
val add_drive_opts : t -> ?readonly:bool -> ?format:string -> ?iface:string -> ?name:string -> ?label:string -> ?protocol:string -> ?server:string array -> ?username:string -> ?secret:string -> ?cachemode:string -> ?discard:string -> ?copyonread:bool -> ?blocksize:int -> string -> unit
(** alias for {!add_drive}
...
class guestfs : ?environment:bool -> ?close_on_exit:bool -> unit -> object
  ...
  (** add the disk(s) from a named libvirt domain
    ...
    @since 1.7.4
   *)
  method add_drive : ?readonly:bool -> ?format:string -> ?iface:string -> ?name:string -> ?label:string -> ?protocol:string -> ?server:string array -> ?username:string -> ?secret:string -> ?cachemode:string -> ?discard:string -> ?copyonread:bool -> ?blocksize:int -> string -> unit
  (** add an image to examine or modify

    @since 0.3
   *)
  method add_drive_opts : ?readonly:bool -> ?format:string -> ?iface:string -> ?name:string -> ?label:string -> ?protocol:string -> ?server:string array -> ?username:string -> ?secret:string -> ?cachemode:string -> ?discard:string -> ?copyonread:bool -> ?blocksize:int -> string -> unit
  (** alias for {!add_drive}
  ...
  (** get Windows CurrentControlSet of inspected operating system
    ...
    @since 1.9.17
   *)
  method inspect_get_windows_group_policy : string -> bool
  (** return if Windows guest has group policy
  ...
  (** probe NTFS volume
    ...
    @since 1.0.43
   *)
  method ntfs_chmod : ?recursive:bool -> string -> int -> string -> unit
  (** change file permissions on NTFS filesystem
  ...
  (** set SELinux security context
    ...
    @since 1.0.67
   *)
  method setfiles : ?force:bool -> string -> string array -> unit
  (** low level relabel parts of the filesystem
