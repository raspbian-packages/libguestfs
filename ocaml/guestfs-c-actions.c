...
copy_application2 (const struct guestfs_application2 *application2)
{
  ...
  Store_field (rv, 12, v);
  v = caml_copy_string (application2->app2_class);
  Store_field (rv, 13, v);
...
copy_lvm_lv (const struct guestfs_lvm_lv *lvm_lv)
{
  ...
  Store_field (rv, 0, v);
  v = caml_alloc_initialized_string (32, lvm_lv->lv_uuid);
  Store_field (rv, 1, v);
...
copy_lvm_pv (const struct guestfs_lvm_pv *lvm_pv)
{
  ...
  Store_field (rv, 0, v);
  v = caml_alloc_initialized_string (32, lvm_pv->pv_uuid);
  Store_field (rv, 1, v);
...
copy_lvm_vg (const struct guestfs_lvm_vg *lvm_vg)
{
  ...
  Store_field (rv, 0, v);
  v = caml_alloc_initialized_string (32, lvm_vg->vg_uuid);
  Store_field (rv, 1, v);
...
/* Automatically generated wrapper for function
 * val add_drive : t -> ?readonly:bool -> ?format:string -> ?iface:string -> ?name:string -> ?label:string -> ?protocol:string -> ?server:string array -> ?username:string -> ?secret:string -> ?cachemode:string -> ?discard:string -> ?copyonread:bool -> ?blocksize:int -> string -> unit
 */

/* Emit prototype to appease gcc's -Wmissing-prototypes. */
value guestfs_int_ocaml_add_drive (value gv, value readonlyv, value formatv, value ifacev, value namev, value labelv, value protocolv, value serverv, value usernamev, value secretv, value cachemodev, value discardv, value copyonreadv, value blocksizev, value filenamev);

value
guestfs_int_ocaml_add_drive (value gv, value readonlyv, value formatv, value ifacev, value namev, value labelv, value protocolv, value serverv, value usernamev, value secretv, value cachemodev, value discardv, value copyonreadv, value blocksizev, value filenamev)
{
  CAMLparam5 (gv, readonlyv, formatv, ifacev, namev);
  CAMLxparam5 (labelv, protocolv, serverv, usernamev, secretv);
  CAMLxparam5 (cachemodev, discardv, copyonreadv, blocksizev, filenamev);
  CAMLlocal1 (rv);
...
{
  return guestfs_int_ocaml_add_drive (argv[0], argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7], argv[8], argv[9], argv[10], argv[11], argv[12], argv[13], argv[14]);
}
...
/* Emit prototype to appease gcc's -Wmissing-prototypes. */
value guestfs_int_ocaml_add_drive_scratch (value gv, value namev, value labelv, value blocksizev, value sizev);

value
guestfs_int_ocaml_add_drive_scratch (value gv, value namev, value labelv, value blocksizev, value sizev)
{
  CAMLparam5 (gv, namev, labelv, blocksizev, sizev);
  CAMLlocal1 (rv);
...
guestfs_int_ocaml_getxattr (value gv, value pathv, value namev)
{
  ...
  rv = caml_alloc_initialized_string (size, r);
  free (r);
  CAMLreturn (rv);
}
...
/* Automatically generated wrapper for function
 * val inspect_get_windows_group_policy : t -> string -> bool
 */

/* Emit prototype to appease gcc's -Wmissing-prototypes. */
value guestfs_int_ocaml_inspect_get_windows_group_policy (value gv, value rootv);

value
guestfs_int_ocaml_inspect_get_windows_group_policy (value gv, value rootv)
{
  CAMLparam2 (gv, rootv);
  CAMLlocal1 (rv);
  ...
  guestfs_h *g = Guestfs_val (gv);
  if (g == NULL)
    guestfs_int_ocaml_raise_closed ("inspect_get_windows_group_policy");
  ...
  free (root);
  if (r == -1)
    guestfs_int_ocaml_raise_error (g, "inspect_get_windows_group_policy");
...
/* Emit prototype to appease gcc's -Wmissing-prototypes. */
value guestfs_int_ocaml_luks_uuid (value gv, value devicev);

value
guestfs_int_ocaml_luks_uuid (value gv, value devicev)
{
  CAMLparam2 (gv, devicev);
  CAMLlocal1 (rv);
  ...
  guestfs_h *g = Guestfs_val (gv);
  if (g == NULL)
    guestfs_int_ocaml_raise_closed ("luks_uuid");
  ...
  free (device);
  if (r == NULL)
    guestfs_int_ocaml_raise_error (g, "luks_uuid");
...
/* Automatically generated wrapper for function
 * val ntfs_chmod : t -> ?recursive:bool -> string -> int -> string -> unit
 */

/* Emit prototype to appease gcc's -Wmissing-prototypes. */
value guestfs_int_ocaml_ntfs_chmod (value gv, value recursivev, value devicev, value modev, value pathv);

value
guestfs_int_ocaml_ntfs_chmod (value gv, value recursivev, value devicev, value modev, value pathv)
{
  CAMLparam5 (gv, recursivev, devicev, modev, pathv);
  CAMLlocal1 (rv);

  guestfs_h *g = Guestfs_val (gv);
  if (g == NULL)
    guestfs_int_ocaml_raise_closed ("ntfs_chmod");
  ...
  if (recursivev != Val_int (0)) {
    optargs_s.bitmask |= GUESTFS_NTFS_CHMOD_RECURSIVE_BITMASK;
    optargs_s.recursive = Bool_val (Field (recursivev, 0));
  }
  int r;
  ...
  free (path);
  if (r == -1)
    guestfs_int_ocaml_raise_error (g, "ntfs_chmod");
...
/* Automatically generated wrapper for function
 * val setfiles : t -> ?force:bool -> string -> string array -> unit
 */

/* Emit prototype to appease gcc's -Wmissing-prototypes. */
value guestfs_int_ocaml_setfiles (value gv, value forcev, value specfilev, value pathsv);

value
guestfs_int_ocaml_setfiles (value gv, value forcev, value specfilev, value pathsv)
{
  CAMLparam4 (gv, forcev, specfilev, pathsv);
  CAMLlocal1 (rv);

  guestfs_h *g = Guestfs_val (gv);
  if (g == NULL)
    guestfs_int_ocaml_raise_closed ("setfiles");

  char *specfile;
  specfile = strdup (String_val (specfilev));
  if (specfile == NULL) caml_raise_out_of_memory ();
  char **paths = guestfs_int_ocaml_strings_val (g, pathsv);
  struct guestfs_setfiles_argv optargs_s = { .bitmask = 0 };
  struct guestfs_setfiles_argv *optargs = &optargs_s;
  if (forcev != Val_int (0)) {
    optargs_s.bitmask |= GUESTFS_SETFILES_FORCE_BITMASK;
    optargs_s.force = Bool_val (Field (forcev, 0));
  }
  int r;
  ...
  caml_acquire_runtime_system ();
  free (specfile);
  guestfs_int_free_string_list (paths);
  if (r == -1)
    guestfs_int_ocaml_raise_error (g, "setfiles");
