                                        ...
                                        const char *val)
{
  ...
  for (i = 0; i < n; ++i) {
    strs[i] = safe_malloc (g, 32);
    snprintf (strs[i], 32, "%zu", i);
  }
  strs[n] = NULL;
  return strs;
}
                                       ...
                                       const char *val)
{
  ...
  for (i = 0; i < n; ++i) {
    strs[i*2] = safe_malloc (g, 32);
    strs[i*2+1] = safe_malloc (g, 32);
    snprintf (strs[i*2], 32, "%zu", i);
    snprintf (strs[i*2+1], 32, "%zu", i);
  }
  strs[n*2] = NULL;
  return strs;
}
