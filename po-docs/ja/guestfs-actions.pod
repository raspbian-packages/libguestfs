...
L</guestfs_add_drive_ro> call instead.
...
I<This function is deprecated.> In new code, use the
L</guestfs_internal_get_console_socket> call instead.
...
I<This function is deprecated.> In new code, use the
L</guestfs_selinux_relabel> call instead.
...
(eg. F</dev/sd*>).  Use C<guestfs_list_devices>, C<guestfs_list_partitions>
...
I<This function is deprecated.> In new code, use the
L</guestfs_hivex_value_string> call instead.
...
and raw block device and partition names (like F</dev/sda> and
F</dev/sda1>).
...
was an error.  I<The caller must call C<guestfs_free_statns_list> after
use>.
