...
The following functions: L</guestfs_ntfs_3g_probe> L</guestfs_ntfs_chmod> L</guestfs_ntfsclone_in> L</guestfs_ntfsclone_out> L</guestfs_ntfsfix>
...
The following functions: L</guestfs_selinux_relabel> L</guestfs_setfiles>
