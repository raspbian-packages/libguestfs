...
dispatch_incoming_message (XDR *xdr_in)
{
  switch (proc_nr) {
    ...
    case GUESTFS_PROC_INSPECT_GET_WINDOWS_CURRENT_CONTROL_SET:
      ...
      break;
    case GUESTFS_PROC_INSPECT_GET_WINDOWS_GROUP_POLICY:
      inspect_get_windows_group_policy_stub (xdr_in);
      break;
    ...
    case GUESTFS_PROC_LUKS_OPEN_RO:
      ...
      break;
    case GUESTFS_PROC_LUKS_UUID:
      luks_uuid_stub (xdr_in);
      break;
    ...
    case GUESTFS_PROC_NTFS_3G_PROBE:
      ...
      break;
    case GUESTFS_PROC_NTFS_CHMOD:
      ntfs_chmod_stub (xdr_in);
      break;
    ...
    case GUESTFS_PROC_SETCON:
      setcon_stub (xdr_in);
      break;
    case GUESTFS_PROC_SETFILES:
      setfiles_stub (xdr_in);
      break;
