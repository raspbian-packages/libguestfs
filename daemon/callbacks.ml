...
let init_callbacks () =
  ...
  Callback.register "Findfs.findfs_partlabel" Findfs.findfs_partlabel;
  Callback.register "Findfs.findfs_partuuid" Findfs.findfs_partuuid;
  ...
  Callback.register "Inspect.inspect_get_windows_group_policy" Inspect.inspect_get_windows_group_policy;
  ...
  Callback.register "Sfdisk.part_get_disk_guid" Sfdisk.part_get_disk_guid;
  Callback.register "Sfdisk.part_get_gpt_attributes" Sfdisk.part_get_gpt_attributes;
  Callback.register "Sfdisk.part_get_gpt_guid" Sfdisk.part_get_gpt_guid;
  Callback.register "Sfdisk.part_get_gpt_type" Sfdisk.part_get_gpt_type;
  Callback.register "Sfdisk.part_get_mbr_id" Sfdisk.part_get_mbr_id;
  ...
  Callback.register "Sfdisk.part_set_disk_guid" Sfdisk.part_set_disk_guid;
  Callback.register "Sfdisk.part_set_disk_guid_random" Sfdisk.part_set_disk_guid_random;
  Callback.register "Sfdisk.part_set_gpt_attributes" Sfdisk.part_set_gpt_attributes;
  Callback.register "Sfdisk.part_set_gpt_guid" Sfdisk.part_set_gpt_guid;
  ...
  Callback.register "Selinux.selinux_relabel" Selinux.selinux_relabel;
  Callback.register "Selinux.setfiles" Selinux.setfiles;
