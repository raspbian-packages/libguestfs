...
/**
    ...
    throws LibGuestFSException
  {
    ...
    _add_drive (g, filename, _optargs_bitmask, readonly, format, iface, name, label, protocol, server, username, secret, cachemode, discard, copyonread, blocksize);
  }
  ...
  private native void _add_drive (long g, String filename, long _optargs_bitmask, boolean readonly, String format, String iface, String name, String label, String protocol, String[] server, String username, String secret, String cachemode, String discard, boolean copyonread, int blocksize)
    throws LibGuestFSException;
    ...
    throws LibGuestFSException
  {
    ...
    _add_drive_scratch (g, size, _optargs_bitmask, name, label, blocksize);
  }
  ...
  private native void _add_drive_scratch (long g, long size, long _optargs_bitmask, String name, String label, int blocksize)
    throws LibGuestFSException;
   ...
   * too long for them. Furthermore, sockets and PID files
   * must be accessible to such background services started
   * by libguestfs that may not have permission to access the
   * temporary directory returned by "g.get_tmpdir".
   * </p><p>
   ...
   * </p><p>
   * This returns true if the Windows guest has group policy.
   * Group policy can interfere with device driver
   * installation, preventing libguestfs features like driver
   * injection from working.
   * </p><p>
   * Note that the presence of group policy is only an
   * indication that there may be a problem with driver
   * installation. As group policy is extremely complex and
   * covers many different aspects of Windows configuration,
   * and we make no attempt to parse it, presence of group
   * policy should only raise a warning.
   * </p><p>
   * This call assumes that the guest is Windows and that the
   * Registry could be examined by inspection. If this is not
   * the case then an error is returned.
   ...
   * @throws LibGuestFSException If there is a libguestfs error.
   */
  public boolean inspect_get_windows_group_policy (String root)
    throws LibGuestFSException
  {
    if (g == 0)
      throw new LibGuestFSException ("inspect_get_windows_group_policy: handle is closed");

    return _inspect_get_windows_group_policy (g, root);
  }

  private native boolean _inspect_get_windows_group_policy (long g, String root)
    throws LibGuestFSException;
   ...
   * </p><p>
   * "app2_class"
   * Classification or primary use of this application.
   * Currently the only defined classification is
   * "antivirus" for Windows antivirus software. If
   * unknown this is returned as an empty string "".
   * </p><p>
   * Please read "INSPECTION" in guestfs(3) for more details.
   * </p>
   * @since 1.19.56
   ...
   * @throws LibGuestFSException If there is a libguestfs error.
   */
  public String luks_uuid (String device)
    throws LibGuestFSException
  {
    if (g == 0)
      throw new LibGuestFSException ("luks_uuid: handle is closed");

    return _luks_uuid (g, device);
  }

  private native String _luks_uuid (long g, String device)
    throws LibGuestFSException;
   ...
   * </p><p>
   * Change file permissions on an NTFS filesystem with a
   * chmod-style permission mask, using ntfssecaudit(8). Only
   * numeric modes are supported.
   * </p><p>
   * *Note*: When using this command from guestfish, "mode"
   * by default would be decimal, unless you prefix it with 0
   * to get octal, ie. use 0700 not 700.
   * </p><p>
   * The "device" parameter is the NTFS partition device (eg.
   * "/dev/sda5"). This must be unmounted. The "mode"
   * parameter is the permission mode (eg. 0744). The "path"
   * parameter is the file or directory path within the
   * filesystem. If the optional "recursive" flag is set,
   ...
   * @throws LibGuestFSException If there is a libguestfs error.
   */
  public void ntfs_chmod (String device, int mode, String path, Map<String, Object> optargs)
    throws LibGuestFSException
  {
    if (g == 0)
      throw new LibGuestFSException ("ntfs_chmod: handle is closed");
    ...
    _optobj = null;
    if (optargs != null)
      _optobj = optargs.get ("recursive");
    if (_optobj != null) {
      recursive = ((Boolean) _optobj).booleanValue();
      _optargs_bitmask |= 1L;
    }

    _ntfs_chmod (g, device, mode, path, _optargs_bitmask, recursive);
  }

  public void ntfs_chmod (String device, int mode, String path)
    throws LibGuestFSException
  {
    ntfs_chmod (device, mode, path, null);
  }

  private native void _ntfs_chmod (long g, String device, int mode, String path, long _optargs_bitmask, boolean recursive)
    throws LibGuestFSException;
   ...
   * read a file
   * </p><p>
   * This call returns the contents of the file "path" as a
   * buffer.
   * </p><p>
   ...
   * </p>
   * @since 1.33.43
   * @deprecated In new code, use {@link #setfiles} instead
   * @throws LibGuestFSException If there is a libguestfs error.
   */
  @Deprecated public void selinux_relabel (String specfile, String path, Map<String, Object> optargs)
    throws LibGuestFSException
  {
    if (g == 0)
   ...
   * </p><p>
   * This invokes the SELinux "setfiles" command which is a
   * low level tool used to relabel parts of the filesystem.
   * </p><p>
   * The "specfile" parameter controls the policy spec file
   * used. You have to parse "/etc/selinux/config" to find
   * the correct SELinux policy and then pass the spec file,
   ...
   * "/contexts/files/file_contexts".
   * </p><p>
   * The required "paths" parameter is the list of top level
   * directories where relabelling starts. "setfiles" will
   * only relabel up to filesystem boundaries so, for
   * example, passing just "/" will relabel the whole root
   * filesystem, but no other mounted filesystems. If the
   * list is empty, setfiles is not called.
   * </p><p>
   * The optional "force" boolean controls whether the
   * context is reset for customizable files, and also
   * whether the user, role and range parts of the file
   ...
   * @throws LibGuestFSException If there is a libguestfs error.
   */
  public void setfiles (String specfile, String[] paths, Map<String, Object> optargs)
    throws LibGuestFSException
  {
    if (g == 0)
      throw new LibGuestFSException ("setfiles: handle is closed");
    ...
    _setfiles (g, specfile, paths, _optargs_bitmask, force);
  }

  public void setfiles (String specfile, String[] paths)
    throws LibGuestFSException
  {
    setfiles (specfile, paths, null);
  }

  private native void _setfiles (long g, String specfile, String[] paths, long _optargs_bitmask, boolean force)
    throws LibGuestFSException;
