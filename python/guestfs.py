...
class GuestFS(object):
    ...
    def inspect_get_windows_group_policy(self, root: str) -> bool:
        ...
        """
        self._check_not_closed()
        r = libguestfsmod.inspect_get_windows_group_policy(self._o, root)
        return r
    ...
    def ntfs_chmod(self, device: str, mode: int, path: str,
                   recursive: Optional[bool] = None) -> None:
        ...
        *Note*: When using this command from guestfish, "mode"
        ...
        """
        self._check_not_closed()
        r = libguestfsmod.ntfs_chmod(self._o, device, mode, path, recursive)
        return r
    ...
    def selinux_relabel(self, specfile: str, path: str,
        ...
        *This function is deprecated.* In new code, use the
        ...
        self._check_not_closed()
        import warnings
        warnings.warn("use GuestFS.setfiles() "
                      "instead of GuestFS.selinux_relabel()",
                      DeprecationWarning, stacklevel=2)
    ...
    def setfiles(self, specfile: str, paths: List[str],
                 force: Optional[bool] = None) -> None:
        ...
        paths = list(paths)
        self._check_not_closed()
        r = libguestfsmod.setfiles(self._o, specfile, paths, force)
        return r
