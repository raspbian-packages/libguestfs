...
PyObject *
guestfs_int_py_cryptsetup_open (PyObject *self, PyObject *args)
{
  PyObject *py_g;
  guestfs_h *g;
  PyObject *py_r = NULL;
...
#ifdef GUESTFS_CRYPTSETUP_OPEN_READONLY_BITMASK
...
#endif
#ifdef GUESTFS_CRYPTSETUP_OPEN_CRYPTTYPE_BITMASK
...
PyObject *
guestfs_int_py_inspect_get_windows_group_policy (PyObject *self, PyObject *args)
{
  PyObject *py_g;
  guestfs_h *g;
  PyObject *py_r = NULL;
  ...
  if (!PyArg_ParseTuple (args, (char *) "Os:guestfs_inspect_get_windows_group_policy",
                         &py_g, &root))
    goto out;
  g = get_handle (py_g);
