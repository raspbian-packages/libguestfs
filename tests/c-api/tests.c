...
test_mke2fs_2_perform (guestfs_h *g)
{
  ...
  optargs2443.uuid = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  ...
  optargs2446.journaldevice = "UUID=87db5559-bc7e-ff29-7b4d-73109dc64b35";
...
test_mke2journal_U_0_perform (guestfs_h *g)
{
  ...
  if (ret2541 == -1)
    return -1;
  const char *arg2549 = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  ...
  const char *arg2556 = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  int ret2552;
...
test_mkswap_2_perform (guestfs_h *g)
{
  ...
  optargs2751.uuid = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  ...
  if (ret == NULL)
      return -1;
  if (! STREQ (ret, "87db5559-bc7e-ff29-7b4d-73109dc64b35")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_mkswap_2", "vfs_uuid", "87db5559-bc7e-ff29-7b4d-73109dc64b35", ret);
    return -1;
  }
  return 0;
}
...
test_mkswap_3_perform (guestfs_h *g)
{
  ...
  optargs2760.uuid = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
...
test_mkswap_U_0_perform (guestfs_h *g)
{
  ...
  if (ret2772 == -1)
    return -1;
  const char *arg2777 = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
...
test_set_e2uuid_0_perform (guestfs_h *g)
{
  ...
  const char *arg3597 = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  int ret3595;
  ...
  if (! STREQ (ret, "87db5559-bc7e-ff29-7b4d-73109dc64b35")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_set_e2uuid_0", "get_e2uuid", "87db5559-bc7e-ff29-7b4d-73109dc64b35", ret);
    return -1;
  }
  return 0;
}
...
test_set_uuid_0_perform (guestfs_h *g)
{
  ...
  const char *arg3645 = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  int ret3643;
  ...
  if (! STREQ (ret, "87db5559-bc7e-ff29-7b4d-73109dc64b35")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_set_uuid_0", "vfs_uuid", "87db5559-bc7e-ff29-7b4d-73109dc64b35", ret);
    return -1;
  }
  return 0;
}
...
test_swapon_uuid_0_perform (guestfs_h *g)
{
  ...
  optargs3724.uuid = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  optargs3724.bitmask = UINT64_C(0x2);
  int ret3722;
  ret3722 = guestfs_mkswap_opts_argv (g, arg3723, &optargs3724);
  if (ret3722 == -1)
    return -1;
  const char *arg3726 = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  int ret3725;
  ret3725 = guestfs_swapon_uuid (g, arg3726);
  if (ret3725 == -1)
    return -1;
  const char *arg3729 = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  int ret3728;
...
test_vfs_uuid_0_perform (guestfs_h *g)
{
  ...
  const char *arg4056 = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  int ret4054;
  ...
  if (! STREQ (ret, "87db5559-bc7e-ff29-7b4d-73109dc64b35")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_vfs_uuid_0", "vfs_uuid", "87db5559-bc7e-ff29-7b4d-73109dc64b35", ret);
    return -1;
  }
  return 0;
}
...
test_xfs_admin_0_perform (guestfs_h *g)
{
  ...
  optargs4333.uuid = "87db5559-bc7e-ff29-7b4d-73109dc64b35";
  ...
  if (! STREQ (ret, "87db5559-bc7e-ff29-7b4d-73109dc64b35")) {
    fprintf (stderr, "%s: test failed: expected last command %s to return \"%s\" but it returned \"%s\"\n",
             "test_xfs_admin_0", "vfs_uuid", "87db5559-bc7e-ff29-7b4d-73109dc64b35", ret);
    return -1;
  }
  return 0;
}
