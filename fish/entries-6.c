...
struct command_entry inspect_get_windows_group_policy_cmd_entry = {
  .name = "inspect-get-windows-group-policy",
  .help = "NAME\n"
          "    inspect-get-windows-group-policy - return if Windows guest has group\n"
          "    policy\n"
          "\n"
          "SYNOPSIS\n"
          "     inspect-get-windows-group-policy root\n"
          "\n"
          "DESCRIPTION\n"
          ...
          "\n"
          "",
  .synopsis = "inspect-get-windows-group-policy root",
  .run = run_inspect_get_windows_group_policy
};
...
struct command_entry tar_out_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "    output file: \"compress\", \"gzip\", \"bzip2\", \"xz\", \"lzop\", \"lzma\", \"zstd\".\n"
