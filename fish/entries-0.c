...
struct command_entry add_domain_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "    from a remote libvirt connection (see <https://libvirt.org/remote.html>)\n"
          ...
          "    <https://libvirt.org/uri.html>). If this is not set then we connect to\n"
          ...
          "\n"
          "    If present, the value of \"logical_block_size\" attribute of <blockio/>\n"
          "    tag in libvirt XML will be passed as \"blocksize\" parameter to\n"
          "    \"add_drive_opts\".\n"
          "\n"
...
struct command_entry get_sockdir_cmd_entry = {
  .name = "get-sockdir",
  .help = "NAME\n"
          "    get-sockdir - get the temporary directory for sockets and PID files\n"
          "\n"
          "SYNOPSIS\n"
          "     get-sockdir\n"
          "\n"
          ...
          "    files.\n"
          "\n"
          "    This is different from \"get_tmpdir\", as we need shorter paths for\n"
          "    sockets (due to the limited buffers of filenames for UNIX sockets), and\n"
          "    \"get_tmpdir\" may be too long for them. Furthermore, sockets and PID\n"
          "    files must be accessible to such background services started by\n"
          "    libguestfs that may not have permission to access the temporary\n"
          "    directory returned by \"get_tmpdir\".\n"
          "\n"
...
struct command_entry ntfs_chmod_cmd_entry = {
  .name = "ntfs-chmod",
  .help = "NAME\n"
          "    ntfs-chmod - change file permissions on NTFS filesystem\n"
          "\n"
          "SYNOPSIS\n"
          "     ntfs-chmod device mode path [recursive:true|false]\n"
          "\n"
          "DESCRIPTION\n"
          ...
          "\n"
          "",
  .synopsis = "ntfs-chmod device mode path [recursive:true|false]",
  .run = run_ntfs_chmod
};
...
struct command_entry resize2fs_M_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "    to its minimum size. This works like the *-M* option to the resize2fs(8)\n"
          "    command.\n"
          "\n"
