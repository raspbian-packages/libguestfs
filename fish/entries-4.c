...
struct command_entry inspect_get_format_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "\n"
          "    In libguestfs ≥ 1.38, this only returns \"installed\". Use libosinfo\n"
...
struct command_entry setfiles_cmd_entry = {
  .name = "setfiles",
  .help = "NAME\n"
          "    setfiles - low level relabel parts of the filesystem\n"
          "\n"
          "SYNOPSIS\n"
          "     setfiles specfile paths [force:true|false]\n"
          "\n"
          "DESCRIPTION\n"
          ...
          "\n"
          "    The required \"paths\" parameter is the list of top level directories\n"
          "    where relabelling starts. \"setfiles\" will only relabel up to filesystem\n"
          ...
          "\n"
          "",
  .synopsis = "setfiles specfile paths [force:true|false]",
  .run = run_setfiles
};
