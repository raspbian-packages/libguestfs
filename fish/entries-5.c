...
struct command_entry sfdisk_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "    *-C*, *-H* and *-S* parameters. If you pass 0 for any of these, then the\n"
          "    corresponding parameter is omitted. Usually for ‘large’ disks, you can\n"
          "    just pass 0 for these, but for small (floppy-sized) disks, sfdisk(8) (or\n"
...
struct command_entry user_cancel_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "    also need to call \"set_pgroup\" so that child processes don't receive the\n"
          "    \"^C\" signal).\n"
          "\n"
