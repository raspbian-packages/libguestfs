...
struct command_entry add_drive_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "        512 (the default if the parameter is omitted) or 4096. Use 4096 when\n"
          ...
          "\n"
          "",
  .synopsis = "add-drive filename [readonly:true|false] [format:..] [iface:..] [name:..] [label:..] [protocol:..] [server:..] [username:..] [secret:..] [cachemode:..] [discard:..] [copyonread:true|false] [blocksize:N]",
  .run = run_add_drive
};
...
struct command_entry add_drive_scratch_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "\n"
          "    The optional arguments \"name\", \"label\" and \"blocksize\" are passed\n"
          "    through to \"add_drive_opts\".\n"
          "\n"
          "    You can use 'scratch' as an alias for this command.\n"
          "\n"
          "",
  .synopsis = "add-drive-scratch size [name:..] [label:..] [blocksize:N]",
...
struct command_entry drop_caches_cmd_entry = {
  ...
  .help = "NAME\n"
          ...
          "    precisely to drop, see <https://linux-mm.org/Drop_Caches>\n"
          "\n"
