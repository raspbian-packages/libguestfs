...
extern int run_inspect_get_windows_group_policy (const char *cmd, size_t argc, char *argv[]);
...
extern int run_ntfs_chmod (const char *cmd, size_t argc, char *argv[]);
...
extern int run_setfiles (const char *cmd, size_t argc, char *argv[]);
